...
| [`decision-record-snapshot`](./skills/methodology/decision-record-snapshot/SKILL.md) | Capture lightweight decision records with source, rationale, scope, and revisit triggers. |
...
| [`handoff-readiness-brief`](./skills/methodology/handoff-readiness-brief/SKILL.md) | Make active work state transferable before pausing, resuming, reviewing, or handing off. |
| [`implementation-drift-check`](./skills/methodology/implementation-drift-check/SKILL.md) | Check changed artifacts against stated intent to catch scope drift and unrelated edits. |
...
| [`release-readiness-brief`](./skills/methodology/release-readiness-brief/SKILL.md) | Decide whether a change is ready to release, needs evidence, or should be held. |
| [`review-comment-action-plan`](./skills/methodology/review-comment-action-plan/SKILL.md) | Turn review comments into an ordered action plan with clarifications, deferrals, and verification. |
